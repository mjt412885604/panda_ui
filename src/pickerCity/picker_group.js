...
class PickerGroup extends Component {
    ...
    adjustPosition = (props) => {
        ...
        this.setState({
            selected: defaultIndex, ogTranslate: translate, totalHeight, translate,
    ...
    render() {
        ...
        const cls = classNames('pandaui-picker__group', className);
        const styles = {
        ...
        return (
            <div className={cls}
                ...
                ref={this.preventDefault}
                {...others}
            >
                <div className="pandaui-picker__mask"></div>
                <div className="pandaui-picker__indicator"></div>
                <div className="pandaui-picker__content"
                    style={styles}
                    ref="content">
                    {items.map((item, j) => {
                        const label = item[this.props.mapKeys.label];
                        const itemCls = classNames('pandaui-picker__item', {
                            'pandaui-picker__item_disabled': item.disabled
                        });
